...
const TimetableTable = () => {
    ...
    const filterWeek = () => {
        ...
        const now = new Date();
        console.log('Hôm nay:', now.toLocaleDateString('vi-VN'));
    ...
    return (
        <div className="timetable-list-container">
            ...
            <div className="week-navigation">
                <Button icon={<LeftOutlined />} onClick={() => setCurrentWeek((w) => w - 1)} />
                <Tag icon={<CalendarOutlined />}>{weekRange()}</Tag>
                <Button icon={<RightOutlined />} onClick={() => setCurrentWeek((w) => w + 1)} />
            </div>
