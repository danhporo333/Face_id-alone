...
import { updateTkb, fetchAllSubjects, fetchAllTeachers, fetchAllRooms } from '../../../services/api.service.js';

const UpdateTkb = (props) => {
    const { isUpdateModalOpen, setIsUpdateModalOpen, selectedTkb, loadDataTkb } = props;
    ...
    useEffect(() => {
        if (selectedTkb) {
            ...
            setMonHoc(selectedTkb.monHoc?.mamh || '');
    ...
    return (
        ...
        >
            ...
            <div>
                ...
                <Select style={{ width: '100%' }} value={giangVien} onChange={(value) => setGiangVien(value)}>
            ...
            <div>
                ...
                <Select style={{ width: '100%' }} value={sop} onChange={(value) => setSop(value)}>
                    {roomList.map((sp) => (
