...
import { updateClass, fetchAllKhoaVien } from '../../../services/api.service.js';

const UpdateClass = ({ isUpdateModalOpen, setIsUpdateModalOpen, selectedClass, loadDataClass }) => {
    ...
    const handleUpdate = async () => {
        try {
            ...
            const resUpdate = await updateClass(selectedClass.malop, nameClass, siso, khoaVien);
            if (resUpdate.data) {
    ...
    return (
        ...
        >
            <div className="form-group">
                <label>Tên lớp:</label>
                <Input value={nameClass} onChange={(e) => setNameClass(e.target.value)} />
            </div>
            <div className="form-group">
                <label>Sĩ số:</label>
                <Input type="number" value={siso} onChange={(e) => setSiso(e.target.value)} />
            </div>
            <div className="form-group">
